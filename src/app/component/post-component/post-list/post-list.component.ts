...
import {ChatDialogComponent} from '../../chat-component/chat-dialog/chat-dialog.component';
...
export class PostListComponent implements OnInit {
  ...
  selectedElementEdit(selectedId: string) {

    this.router.navigate(['/postEditor/' + selectedId]);
    // this.store.dispatch(new SelectPost(selectedId));
